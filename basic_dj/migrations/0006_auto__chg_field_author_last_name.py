...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'basic_dj_author', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'Author.last_name'
        db.alter_column(u'basic_dj_author', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        u'basic_dj.book': {
            ...
            'author': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'books'", 'symmetrical': 'False', 'to': u"orm['basic_dj.Author']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
