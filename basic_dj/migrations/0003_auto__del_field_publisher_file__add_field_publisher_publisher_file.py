...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publisher.file'
        db.delete_column(u'basic_dj_publisher', 'file')

        # Adding field 'Publisher.publisher_file'
        db.add_column(u'basic_dj_publisher', 'publisher_file',
                      self.gf('django.db.models.fields.files.FileField')(default='default.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Publisher.file'
        db.add_column(u'basic_dj_publisher', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default='default.png', max_length=100),
                      keep_default=False)

        # Deleting field 'Publisher.publisher_file'
        db.delete_column(u'basic_dj_publisher', 'publisher_file')
